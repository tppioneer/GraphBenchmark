...
| `AIS-003` | 保存原始响应并生成 Agent Answer | READY_FOR_REVIEW | AIS-002 |
| `AIS-004` | 加载 Profile 并验证 GT Rubric | READY_FOR_REVIEW | AIS-002 |
| `AIS-005` | 确定性计算 item、维度、总分和 cap | DRAFT | AIS-004 |
| `AIS-006` | 形成多 Judge 共识和人工复核有效分 | DRAFT | AIS-005 |
| `AIS-007` | 生成盲评输入、digest 与缓存键 | READY_FOR_REVIEW | AIS-002 |
